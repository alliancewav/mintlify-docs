...
<AccordionGroup>
  ...
  <Accordion title="Account disabled" icon="user-slash">
    ...
    **Resolution:** Contact [support@beatpass.ca](mailto:support@beatpass.ca) for assistance.
  </Accordion>
    ...
    <AccordionGroup>
      <Accordion title="File too large" icon="file-arrow-up">
        <Badge color="orange">422</Badge>
         File exceeds maximum size (~250MB).
      ...
      <Accordion title="Duration issues" icon="clock">
        <Badge color="orange">422</Badge>
         Track too short (\<30s) or too long (\>15min).

        **Resolution:** Ensure track is between 30 seconds and 15 minutes.
      </Accordion>
      <Accordion title="Missing required fields" icon="input-text">
        <Badge color="orange">422</Badge>
