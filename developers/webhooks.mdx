...
<Tabs>
  ...
  <Tab title="Payout Events">
    <AccordionGroup>
      <Accordion title="payout.created" defaultOpen icon="clock">
        ...
        Notifies producer that payout was initiated to their bank account.
      </Accordion>
      <Accordion title="payout.paid" icon="circle-check">
        <Badge color="green">Deposited</Badge>
        Notifies producer that payout was deposited successfully.
      </Accordion>
      <Accordion title="payout.failed" icon="circle-xmark">
        <Badge color="red">Failed</Badge>
        Notifies producer of payout failure with the error reason.
      </Accordion>
    </AccordionGroup>
  </Tab>
  <Tab title="Account Events">
    <Accordion title="account.updated" defaultOpen icon="rotate">
      ...
      Syncs Stripe Connect account status. Notifies producer if action is required (verification, document upload, etc.).
    </Accordion>
  </Tab>
</Tabs>
