...
<Steps>
  <Step title="Go to Login Page">
    Open the BeatPass sign-in page at [https://open.beatpass.ca/login](https://open.beatpass.ca/login).
  </Step>
  <Step title="Click Forgot password?">
    Select [**Forgot password?**](https://open.beatpass.ca/forgot-password) below the **Password** field.
  </Step>
  ...
  <Step title="Create New Password">
    On the reset screen, enter **Email address**, **New password**, and **Confirm password**, then click **Reset password**.
  </Step>
  <Step title="Log In">
