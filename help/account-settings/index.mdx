...
2. Scroll to the section you want to manage

You will land on the main account settings page. Some sections only appear when they are available for your account, such as **Social login** or **Developers**.
