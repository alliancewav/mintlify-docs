...
<CardGroup cols={2}>
  <Card title="Uploading but not promoting" icon="x-circle">
    Tracks need plays to earn. Don't just upload and hope for the best.
  </Card>
  <Card title="Ignoring your existing catalog" icon="x-circle">
    Your older tracks can still earn. Don't forget to promote them occasionally.
  </Card>
  <Card title="Incomplete payment setup" icon="x-circle">
    You earn nothing if your Stripe account isn't fully configured.
  </Card>
  <Card title="Only focusing on quantity" icon="x-circle">
