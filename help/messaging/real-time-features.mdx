...
og:description: "Understand live messaging states on BeatPass."
---
...
- **Conversation list:** shows `typing...` for the active conversation preview
- **Open chat view:** shows the animated typing indicator near the bottom of the thread

In group chats, BeatPass can show multiple typing participants at once.
