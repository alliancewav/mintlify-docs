...
<CardGroup cols={2}>
  ...
  <Card title="Tax Documents" icon="file-text">
...
<Card title="Earnings Formula" icon="calculator" href="/help/earnings/formula">
...
<CardGroup cols={2}>
  ...
  <Card title="Pricing Your Tracks" icon="tag" href="/help/licensing-commerce/pricing">
