...
Purchasing an exclusive license is a one-time transaction that gives you full ownership rights to a beat. Payment is processed securely via Stripe.
...
| **Platform fee** | BeatPass takes commission |
...
- Contact support with issues
- If refunded, license is revoked
