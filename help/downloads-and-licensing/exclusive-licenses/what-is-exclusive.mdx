...
- **Sole and exclusive rights** — No one else can license this beat
...
- **Sole and exclusive rights** to use the beat
- The beat is yours alone — no one else can license it
- Complete control over usage
- Publishing split with producer (default 20% producer / 80% you)
