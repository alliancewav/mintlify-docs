...
<AccordionGroup>
  ...
  <Accordion title="Treating budget like an in-app payment">
    Budget helps set expectations, but BeatPass does not process a separate beat-request payment for you. Licensing or custom deals still happen directly with the producer.
  </Accordion>
