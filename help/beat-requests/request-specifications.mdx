...
- Enter a numeric amount or range (e.g., `50-100`, `200`, `500+`)
- Select a **currency** from the dropdown: **USD**, **EUR**, **GBP**, or **CAD**
- The currency is automatically appended when your request is posted (e.g., "$50-100 USD")
