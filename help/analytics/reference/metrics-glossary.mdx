...
This glossary focuses on the labels producers can actually see in the current Backstage Insights UI.
...
<AccordionGroup>
  ...
  <Accordion title="Track Count">
    The number of tracks inside the current album or artist context.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="Completed Listens">
    A current BeatPass completed listen is a listen above 80% of the track.
  </Accordion>
</AccordionGroup>
